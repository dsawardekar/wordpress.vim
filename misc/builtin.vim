...
\ 'add_rewrite_endpoint(': 'string $name, int $places, string $query_var | void',
...
\ 'get_post_taxonomies(': 'int|\WP_Post $post | array',
...
\ 'is_attachment(': 'mixed $attachment | bool',
...
\ 'add_image_size(': 'string $name, int $width, int $height, bool|array $crop | bool|array',
\ 'has_image_size(': 'string $name | bool',
\ 'remove_image_size(': 'string $name | bool',
\ 'set_post_thumbnail_size(': 'int $width, int $height, bool|array $crop | bool|array',
...
\ 'image_resize_dimensions(': 'int $orig_w, int $orig_h, int $dest_w, int $dest_h, bool|array $crop | bool|array',
...
\ 'get_post_galleries(': 'int|\WP_Post $post, bool $html | array',
\ 'get_post_gallery(': 'int|\WP_Post $post, bool $html | string|array',
...
\ 'the_guid(': 'int|\WP_Post $id | void',
\ 'get_the_guid(': 'int|\WP_Post $id | string',
...
\ 'has_excerpt(': 'int|\WP_Post $id | bool',
\ 'post_class(': 'string|array $class, int|\WP_Post $post_id | void',
\ 'get_post_class(': 'string|array $class, int|\WP_Post $post_id | array',
...
\ 'the_attachment_link(': 'int|\WP_Post $id, bool $fullsize, bool $deprecated, bool $permalink | void',
\ 'wp_get_attachment_link(': 'int|\WP_Post $id, string $size, bool $permalink, bool $icon, string|bool $text | string',
...
\ 'wp_list_post_revisions(': 'int|\WP_Post $post_id, string $type | null',
\}
...
\ 'get_the_date(': 'string $d, int|\WP_Post $post | string',
...
\ 'get_the_time(': 'string $d, int|\WP_Post $post | string|int',
\ 'get_post_time(': 'string $d, bool $gmt, int|\WP_Post $post, bool $translate | string|int',
...
\ 'get_post(': 'int|\WP_Post $post, string $output, string $filter | \WP_Post|null',
\ 'get_post_ancestors(': 'int|\WP_Post $post | array',
\ 'get_post_field(': 'string $field, int|\WP_Post $post, string $context | string',
\ 'get_post_mime_type(': 'int|\WP_Post $ID | string|bool',
\ 'get_post_status(': 'int|\WP_Post $ID | string|bool',
...
\ 'get_post_type(': 'int|\WP_Post $post | string|bool',
...
\ 'wp_trash_post_comments(': 'int|\WP_Post $post | mixed',
\ 'wp_untrash_post_comments(': 'int|\WP_Post $post | mixed',
...
\ 'wp_publish_post(': 'int|\WP_Post $post | void',
\ 'check_and_publish_future_post(': 'int|\WP_Post $post_id | null',
...
\ 'set_post_thumbnail(': 'int|\WP_Post $post, int $thumbnail_id | bool',
...
\ 'get_category(': 'int|object $category, string $output, string $filter | object|array|\WP_Error|null',
...
\ 'get_tag(': 'int|object $tag, string $output, string $filter | object|array|\WP_Error|null',
...
\ 'get_the_permalink(': 'int|\WP_Post $id, bool $leavename | string|bool',
...
\ 'edit_comment_link(': 'string $link, string $before, string $after | void',
...
\ 'get_boundary_post(': 'bool $in_same_term, array|string $excluded_terms, bool $start, string $taxonomy | mixed',
...
\ 'get_edit_profile_url(': 'int $user_id, string $scheme | string',
...
\ 'get_network_by_path(': 'string $domain, string $path, int|null $segments | object|bool',
\ 'wp_get_network(': 'object|int $network | object|bool',
\ 'get_site_by_path(': 'string $domain, string $path, int|null $segments | object|bool',
...
\ 'wp_signon(': 'array $credentials, bool $secure_cookie | \WP_User|\WP_Error',
...
\ 'wp_validate_logged_in_cookie(': ' $user_id | int|bool',
...
\ 'update_user_option(': 'int $user_id, string $option_name, mixed $newvalue, bool $global | int|bool',
\ 'delete_user_option(': 'int $user_id, string $option_name, bool $global | bool',
...
\ 'timer_stop(': 'int $display, int $precision | string',
...
\ 'doing_filter(': 'null|string $filter | bool',
\ 'doing_action(': 'string|null $action | bool',
...
\ 'wp_register_plugin_realpath(': 'string $file | bool',
...
\ 'unregister_default_headers(': 'string|array $header | bool|void',
...
\ 'add_theme_support(': 'string $feature | void|bool',
...
\ 'wp_update_nav_menu_object(': 'int $menu_id, array $menu_data | int|\WP_Error',
\ 'wp_update_nav_menu_item(': 'int $menu_id, int $menu_item_db_id, array $menu_item_data | int|\WP_Error',
...
\    'prepreview_added_widget_instance': { 'signature': 'array|bool|mixed $value', 'return_type': 'array|mixed'},
...
\    'is_wide_widget': { 'signature': 'string $widget_id', 'return_type': 'bool'},
...
\    'tally_sidebars_via_is_active_sidebar_calls': { 'signature': 'bool $is_active,  $sidebar_id', 'return_type': 'void'},
\    'tally_sidebars_via_dynamic_sidebar_calls': { 'signature': 'bool $has_widgets, string $sidebar_id', 'return_type': 'void'},
...
\    'add_endpoint': { 'signature': 'string $name, int $places, string $query_var', 'return_type': 'void'},
...
\  'name': 'PHPMailer',
\  'static_methods': {
\    'validateAddress': { 'signature': 'string $address, string $patternselect', 'return_type': 'bool'},
...
\  },
\  'methods': {
\    '__construct': { 'signature': 'bool $exceptions', 'return_type': 'void'},
...
\    'addAddress': { 'signature': 'string $address, string $name', 'return_type': 'bool'},
\    'addCC': { 'signature': 'string $address, string $name', 'return_type': 'bool'},
\    'addBCC': { 'signature': 'string $address, string $name', 'return_type': 'bool'},
\    'addReplyTo': { 'signature': 'string $address, string $name', 'return_type': 'bool'},
\    'setFrom': { 'signature': 'string $address, string $name, bool $auto', 'return_type': 'bool'},
...
\    'smtpConnect': { 'signature': 'array $options', 'return_type': 'bool'},
...
\    'wrapText': { 'signature': 'string $message, integer $length, bool $qp_mode', 'return_type': 'string'},
...
\    'addAttachment': { 'signature': 'string $path, string $name, string $encoding, string $type, string $disposition', 'return_type': 'bool'},
...
\    'encodeQPphp': { 'signature': 'string $string, integer $line_max, bool $space_conv', 'return_type': 'string'},
...
\    'addEmbeddedImage': { 'signature': 'string $path, string $cid, string $name, string $encoding, string $type, string $disposition', 'return_type': 'bool'},
\    'addStringEmbeddedImage': { 'signature': 'string $string, string $cid, string $name, string $encoding, string $type, string $disposition', 'return_type': 'bool'},
...
\    'msgHTML': { 'signature': 'string $message, string $basedir, bool $advanced', 'return_type': 'string'},
\    'html2text': { 'signature': 'string $html, bool $advanced', 'return_type': 'string'},
...
\    'is_attachment': { 'signature': 'mixed $attachment', 'return_type': 'bool'},
...
\    'db_connect': { 'signature': 'bool $allow_bail', 'return_type': 'bool'},
\    'check_connection': { 'signature': 'bool $allow_bail', 'return_type': 'bool'},
...
\    'resize': { 'signature': 'int|null $max_w, int|null $max_h, boolean $crop', 'return_type': 'boolean|\WP_Error'},
...
\    'get': { 'signature': 'string $header', 'return_type': 'string|bool'},
\    'display': { 'signature': 'string $header, bool $markup, bool $translate', 'return_type': 'string|bool'},
\    'get_stylesheet': { 'signature': 'void', 'return_type': 'string'},
\    'get_template': { 'signature': 'void', 'return_type': 'string'},
...
\    'post': { 'signature': 'string $url, string|array $args', 'return_type': 'array|object'},
...
\    'delete': { 'signature': 'int|string $key, string $group, bool $deprecated', 'return_type': 'bool'},
...
\  'methods': {
\    '__construct': { 'signature': 'void', 'return_type': 'void'},
\    'connect': { 'signature': 'string $host, int $port, int $timeout, array $options', 'return_type': 'bool'},
...
\    'verify': { 'signature': 'string $name', 'return_type': 'bool'},
\    'noop': { 'signature': 'void', 'return_type': 'bool'},
\    'turn': { 'signature': 'void', 'return_type': 'bool'},
\    'client_send': { 'signature': 'string $data', 'return_type': 'int|bool'},
\    'getError': { 'signature': 'void', 'return_type': 'array'},
\    'getLastReply': { 'signature': 'void', 'return_type': 'string'},
\    'setVerp': { 'signature': 'bool $enabled', 'return_type': 'void'},
\    'getVerp': { 'signature': 'void', 'return_type': 'bool'},
\    'setDebugOutput': { 'signature': 'string $method', 'return_type': 'void'},
\    'getDebugOutput': { 'signature': 'void', 'return_type': 'string'},
\    'setDebugLevel': { 'signature': 'int $level', 'return_type': 'void'},
\    'getDebugLevel': { 'signature': 'void', 'return_type': 'int'},
\    'setTimeout': { 'signature': 'int $timeout', 'return_type': 'void'},
\    'getTimeout': { 'signature': 'void', 'return_type': 'int'},
\  },
\},
\}
